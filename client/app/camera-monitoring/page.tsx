...
//         description: "Make sure the Python server is running.",
//       })
//     } finally {
//       setIsLoading(false)
//     }
...
//                 <img src="http://localhost:5000/video_feed" alt="Camera Feed" className="w-full h-full object-cover" />
...
//                     <div key={log._id} className="p-3 bg-red-50 border-l-4 border-red-500 rounded-md text-sm">
